    ...
    <>
      <button aria-label="Toggle Menu" onClick={onToggleNav} className="sm:hidden">
        <svg
          ...
          viewBox="0 0 20 20"
          fill="currentColor"
          className="h-8 w-8 text-zinc-900 hover:text-primary-500 dark:text-zinc-100 dark:hover:text-primary-400"
        >
          <path
            fillRule="evenodd"
                  ...
                  <div className="flex justify-start">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        className="text-zinc-900 hover:text-primary-500 dark:text-zinc-100 dark:hover:text-primary-400"
                      >
                        <path
                          fillRule="evenodd"
